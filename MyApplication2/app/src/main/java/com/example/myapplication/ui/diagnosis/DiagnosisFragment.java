...
public class DiagnosisFragment extends Fragment {
    ...
    public void classifyImage (Bitmap image)
    {
        try {
            ...
            float  r=maxConfidence;
            confidence.setText(String.valueOf(r));
            DatabaseAccessHisto a=DatabaseAccessHisto.getInstance(getActivity().getApplicationContext());
            a.insertData(classes[maxPos] , r, 0 , image) ;
